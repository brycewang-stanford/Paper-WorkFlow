...
> [`references/research-grade-methods.md`](references/research-grade-methods.md)。
...
因此 Stage 3 必须加载 [`references/research-grade-methods.md`](references/research-grade-methods.md)，并完成：
