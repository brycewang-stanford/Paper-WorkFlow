...
[![Rigor](https://img.shields.io/badge/rigor-31%2F31_executable_gates-16A34A?style=flat&labelColor=0D1117)](RIGOR.md)
...
| 端到端案例 | Stage 0–9 全流程标准走查：基于**合成** CFPS 面板（DGP 真值已知，非真实数据）的「互联网使用对收入的影响」12 页论文，含完整 `paper_workspace/`、双闸门证据与最终 PDF | [`社媒文件/7.5-测试案例/`](社媒文件/7.5-测试案例/) |
