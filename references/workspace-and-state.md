...
`00_meta/analysis_backend.md`、`00_meta/evidence_ledger.md` 与
...
| 字段 | 含义 |
|---|---|
| `schema_version` | 模板版本号（当前 `8`；v2 新增 `quality_gate`，v3 新增 `method_gate`，v4 新增 `replication_pack`，v5 新增 `analysis_backend`，v6 新增 `empirical_audit`，v7 新增 `evidence_governance`，v8 新增 `design_risk`） |
