...
## 2. Stage 2 · 数据 → `02_data/clean.parquet` + `codebook.md`
...
**data_audit**：合并键（stkcd×year）唯一、面板近似平衡、winsorize 1% 已记 codebook。✅ → 放行 Stage 3。
...
├── 02_data/{clean.parquet, codebook.md, fetch_csmar.py, data_audit.md}
