...
| 复现与数据政策 | AEA Data & Code Policy: https://www.aeaweb.org/journals/data/data-code-policy | Stage 2 起就记录 data provenance；收尾写 replication README |
