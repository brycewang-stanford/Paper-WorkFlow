...
| 9 | 选刊 / 投稿评估 | **`67/paper-submission`** | 可选 AJS 目标期刊 workflow/submission/profile adapter（精确发现，不计入 47 个内置 skill）、`60-regisely-superpapers`、AEA replication/data-code policy pack |
