<!--
  ...
  目录与 schema 见 references/dataset-cards.md。把 <尖括号> 占位全部替换；拿不准的写「待核查」，不要猜。
-->
...
|---|---|---|
| 选择 (selection/survivorship) | <是/否> | <处理/后果> |
| 测量误差 (measurement) | <是/否> | <处理/后果> |
| 外部效度 (external validity) | <是/否> | <处理/后果> |
| attrition | <是/否> | <处理/后果> |
| linkage error | <是/否> | <处理/后果> |
| look-ahead / vintage | <是/否> | <处理/后果> |
