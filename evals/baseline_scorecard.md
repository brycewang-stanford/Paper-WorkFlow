...
Latest measured: 2026-06-21 (Beijing) · generator: `python3 evals/score_skill.py`
...
time_series_var    selection   1.00  1.00  1.00  1.00  1.00   1.00  success
...
pass the gate self-test, smoke test, and context/user-burden contracts.
